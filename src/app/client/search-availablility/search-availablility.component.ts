...
@Component({
    selector: 'app-search-availablility',
    templateUrl: './search-availablility.component.html',
    styleUrls: [
      '../../../assets/css/orange-blue.css',
      './search-availablility.component.scss']
})
export class SearchAvailablilityComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(
      (params : Params) =>{   
        ...
        this.searchModel.caseId = Number(params["clientId"]);     
