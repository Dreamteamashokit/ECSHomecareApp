...
export class EmployeeapiService {
  ...
  addCompliance(_req: ComplianceModel) {
    var headers_object = new HttpHeaders();
    headers_object.append('Content-Type', 'application/json');
    var headers_object = new HttpHeaders().set("Authorization", "Bearer " + "qatest");
    const httpOptions = {
  ...
  getComplianceList(userId: number) {
    return this._http.get<APIResponse<ComplianceModel[]>>(environment.domain + "/api/Employee/getComplianceList" + '/' + userId);
  }
